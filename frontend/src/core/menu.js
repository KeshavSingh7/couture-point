          ...
          <div className={
            ...
            <ul className="ml-auto flex-col flex align-center lg:flex-row font-custom2 font-semibold">
              <li className="active mt-2 lg:mr-4">
                <Link style={currentTab(history, "/")} to="/" className="hover:no-underline">
                  <div className="p-1 flex justify-end border-b-2 border-transparent hover:border-custom-shade2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 lg:mx-auto"  viewBox="0 0 20 20" fill="currentColor">
              ...
              <li className="mt-2 lg:mr-4">
                <Link style={currentTab(history, "/cart")} to="/cart" className="hover:no-underline">
                  <div className="p-1 flex justify-end border-b-2 border-transparent hover:border-custom-shade2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 lg:mx-auto" viewBox="0 0 20 20" fill="currentColor">
              ...
              {!isAuthenticated() && (
                  <Fragment>
                      <li className="mt-2 lg:mr-4">
                          <Link style={currentTab(history, "/signup")} to="/signup" className="hover:no-underline">
                            <div className="p-1 flex justify-end border-b-2 border-transparent hover:border-custom-shade2">
                              <svg xmlns="http://www.w3.org/2000/svg" className="w-5 lg:mx-auto" viewBox="0 0 20 20" fill="currentColor">
                      ...
                      <li className="mt-2">
                          <Link style={currentTab(history, "/signin")} to="/signin" className="hover:no-underline">
                            <div className="p-1 flex justify-end border-b-2 border-transparent hover:border-custom-shade2">
